...
<body>
    ...
    <!-- Upload Form (admin only) -->
        <form id="uploadNotes" class="upload-form-popup" method="post"
              action="${pageContext.request.contextPath}/uploadNotes"
    ...
    <script>
        function toggleForm() {
            const form = document.getElementById("uploadNotes");
